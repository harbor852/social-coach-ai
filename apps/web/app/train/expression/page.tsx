...
import { mockFeedback } from "@/app/lib/mockData";
import type { TrainingFeedback } from "@/app/lib/mockData";
        ...
        <div className="space-y-4">
          <div className="card">
            <p className="text-sm text-gray-600 mb-3">
              💡 <strong>PREP 结构：</strong>Point（观点）→ Reason（理由）→ Example（例子）→ Point（回到结论）
            </p>
        ...
        <div className="space-y-4 animate-in">
          ...
          <div className="card bg-purple-50 border-purple-200">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">{feedback.reply_text}</p>
              </div>
            </div>
          </div>
          ...
          <div className="card border-primary bg-purple-50">
            ...
            <p className="text-sm text-gray-700 italic">
              &ldquo;{feedback.rewritten_expression}&rdquo;
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-sm text-gray-600">{feedback.next_practice}</p>
          </div>
